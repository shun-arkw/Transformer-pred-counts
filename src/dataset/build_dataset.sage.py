...
_sage_const_123456789 = Integer(123456789); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2)
import os
import time
import argparse
...
def build_dataset(get_dataset_builder, config, save_dir, tag='test', encoding='infix', n_jobs=-_sage_const_1 , timing=False, strictly_conditioned=True):
    ...
    stats = (dbuilder.stats[_sage_const_0 ], dbuilder.stats[_sage_const_1 ]) # F , G
...
def main():
    ...
    if not params.testset_only:
        ...
        build_dataset(get_dataset_builder, config, save_dir, tag='train', encoding=encoding, n_jobs=-_sage_const_1 , timing=False, strictly_conditioned=strictly_conditioned)
